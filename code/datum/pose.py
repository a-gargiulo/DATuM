"""This module provides functions and utilities for computing the BeVERLI stereo PIV
coordinate transformation parameters.

These parameters are used for mapping the BeVERLI stereo PIV data from the local
...
def calculate_global_pose() -> Tuple[float, float, float]:
    ...
    x_1_hill_profile_m, x_2_hill_profile_m = hill.compute_x1_x2_profile(
        x_3_hill_profile_m
    )
